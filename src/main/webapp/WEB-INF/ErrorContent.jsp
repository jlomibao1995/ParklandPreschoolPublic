...
<html data-wf-page="5fcf5929bcd40b2cb489362b" data-wf-site="5fcbddeaf750a0c0eb0dba3c">
    <head>
        <meta charset="utf-8">
    ...
    <div class="utility-page-wrap">
        <div class="utility-page-content w-form"><img src="images/Parlandschoollogo.png" alt="Parkland Logo">
            <h2>ERROR ${errorCode}</h2>
            <div class="div-block-2">Something has gone wrong within our system. Please click here to go to the home page.</div>
            <c:if test="${errorCode eq 'P401'}"><div class="div-block-2">This fee has already been paid</div></c:if>
            <a href="/home" class="button-21 w-button">Home Page</a>
        </div>
    </div>
